...
var getGlobalThis = () => typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof self < "u" ? self : {}, VariableValue = class {
  ...
  getSheetValue() {
    var e, t, r;
    return this.value = ((t = (e = this.source) == null ? void 0 : e.sheetData) == null ? void 0 : t.getValue()) || ((r = this.sheetData) == null ? void 0 : r.getValue()) || 0, this.returnFunc(this.value);
  }
  /**
   * 获取逻辑数字列表值
   * 私有方法，处理数字列表类型的值
  ...
  finalMeleeAttack(e) {
    if (e.length < 8)
      return 0;
    const t = this.getTreeValue(e, 0), r = this.getTreeValue(e, 1), i = this.getTreeValue(e, 2), s = this.getTreeValue(e, 3), l = this.getTreeValue(e, 4), o = this.getTreeValue(e, 5), u = this.getTreeValue(e, 6), d = this.getTreeValue(e, 7);
    return (t * 7 + t / 5 + r / 5 + i / 5 + s + (s + l) * o) * u * d;
  }
  finalRangedAttack(e) {
    if (e.length < 8)
      return 0;
    const t = this.getTreeValue(e, 0), r = this.getTreeValue(e, 1), i = this.getTreeValue(e, 2), s = this.getTreeValue(e, 3), l = this.getTreeValue(e, 4), o = this.getTreeValue(e, 5), u = this.getTreeValue(e, 6), d = this.getTreeValue(e, 7);
    return (t * 5 + t / 5 + r / 5 + i / 5 + s + (s + l) * o) * u * d;
  }
  finalMagicAttack(e) {
    if (e.length < 6)
      return 0;
  ...
  buildWeightedText(e) {
    ...
    for (let r = 0; r < e.length; r += 2)
      t.push(`[值:${e[r].getFormulaTextValue()},权重:${e[r + 1].getFormulaTextValue()}]`);
    return t.join(",");
  }
  ...
  buildForLoopText(e) {
    ...
    const [t, r, i, s] = e.map((l) => l.getFormulaTextValue());
  ...
  buildMeleeAttackText(e) {
    ...
    const [t, r, i, s, l] = e.map((o) => o.getFormulaTextValue());
        ...
        r.name === i.name && r.parameter.forEach((s) => {
          ...
          i.metadataArray.forEach((o) => {
            ...
            if (fx.getStepData(o.body.source, u), u.toString() === l) {
              const h = o.body.getValue(), c = Number(s.value);
              h !== c && o.body.setGlobalValue(c);
            }
          });
        });
      });
  ...
  getValue() {
    ...
    if (!this.originData)
      return 0;
    const t = this.originData.sheets, r = t.find((f) => f.uniqueInfo);
    if (!r)
      return 0;
    const { row: i, col: s } = r.uniqueInfo || {}, l = (d = r == null ? void 0 : r.data) == null ? void 0 : d.get(`${i},${s}`), o = l == null ? void 0 : l.cellData;
    let u = o == null ? void 0 : o.v;
    return o != null && o.type && (u = (h = l == null ? void 0 : l.source) != null && h.getValue ? (c = l.source) == null ? void 0 : c.getValue() : 0), o != null && o.f && (u = o != null && o.getValue ? o.getValue(t) : o.v), u || 0;
  }
...
n(a, "partitionCurve", function(t, r, i, s, l, o) {
  var u = [], d = [], h = l, c = o;
  h == null && (h = 0.382), c == null && (c = 0.618);
  for (var f = 0, g = 1; g <= r; g++) {
    var m = Math.pow(r, i), v = Math.pow(g, i), D = v / m, y = g * (1e4 * h) / r + D * (1e4 * c);
    u.push(y), f += y;
  }
...
n(a, "addLibraryBody", function(t, r) {
  ...
  for (var i = 0; i < r.length; i++) {
    let h = r[i], c = (d = h.sheetData) == null ? void 0 : d.originData;
    if (c && (c = { ...c }, c.sheets = [
      ...c.sheets.map((f) => ({ ...f, data: a.mapToJSON(f.data) }))
    ]), h instanceof a.VariableValue) {
      var s = a.createOperationLayerData(
        ...
        h.tag,
        h.isSystemShow,
        h.sheetData ? JSON.stringify(c) : null,
        h.childCell
      );
      s.id = h.id, t.push(s), a.saveBody(
        s.operationArray,
        a.seekSource(h.childBodyArray)
      );
    }
    if (h instanceof a.Folder) {
      var s = a.createFolderData(
        h.name,
        h.isFolder,
        h
      );
      s.id = h.id, t.push(s), a.addLibraryBody(s.operationArray, h.tree);
    }
    if (a.isBillboardLayerView) {
      if (h instanceof a.BillboardLayer) {
        ...
        s.id = h.id, t.push(s);
        for (var l = 0; l < h.operationArray.length; l++) {
          let g = h.operationArray[l];
        ...
        for (var l = 0; l < h.metadataArray.length; l++) {
          const m = h.metadataArray[l];
          ...
          u.id = m.body.id, s.metadataArray.push(u);
        }
      }
      if (h instanceof a.ChartsLayer) {
        var s = a.createChartData(h);
        s.id = h.id, t.push(s);
      }
    }
  }
      ...
      for (var l = s[0], o = 0; o < u.operationArray.length; o++) {
        ...
        if (h.type == 5) {
          ...
          a.getLibraryBody(
            ...
            a.targetFolder.tree,
            h.site
          ), a.editBody = s[0], a.selectBody = s[0], a.targetStoragePool = s[0].childBodyArray, a.parseStageBody(h.operationArray), a.editBody = l, a.editBody.isSystemShow = h.isSystemShow;
        } else h.isBoard == !0 ? (a.selectBody = a.editBody, h.index = o, a.Call.send(a.Eve.SHIFT_ADD_BOARD, h, null)) : h.isXlsx == !0 && (a.selectBody = a.editBody, h.index = o, a.Call.send(
          a.Eve.SHIFT_ADD_CHARTS,
          h,
          null
        ));
        if (h.isFile == !0) {
          ...
          a.getLibraryBody(
            ...
            a.targetFolder.tree,
            h.site
          ), a.editBody = s[0], a.parseLibraryBody(
            h.operationArray,
            !1
          );
        }
...
n(a, "createLibraryBody", function(t, r, i, s) {
  for (var l = 0; l < t.length; l++) {
    ...
    if (c.isFile == !0) {
      ...
      a.Call.send(a.Eve.CREATE_FILE_DATA, o, null), s != null ? (a.Call.send(a.Eve.ADD_DATABASE_DATA, [o, s], null), a.Call.send(a.Eve.SHIFT_REFRESH_LIBRARY_COORDINATES, [
        o,
        s
      ], null)) : (a.Call.send(a.Eve.ADD_DATABASE_DATA, [o, a.selectBody], null), a.Call.send(a.Eve.SHIFT_REFRESH_LIBRARY_COORDINATES, [
        o,
        a.selectBody
      ], null)), a.selectBody = o, a.selectBody.absoluteAddress = c.site;
      for (var u = 0; u < c.operationArray.length; u++) {
        const f = c.operationArray[u];
        if (f.type == 5)
          a.editBody = new a.VariableValue(
            f.name,
            null,
            5
          ), a.editBody.tag = f.name.tag, a.Call.send(a.Eve.CREATE_OPERATION_DATA, a.editBody, null), a.Call.send(a.Eve.ADD_DATABASE_DATA, [
            a.editBody,
            a.selectBody
          ], null), a.Call.send(a.Eve.SHIFT_REFRESH_LIBRARY_COORDINATES, [
            a.editBody,
            a.selectBody
          ], null), a.editBody.absoluteAddress = f.site, a.targetStoragePool = a.editBody.childBodyArray;
        else if (f.type == 0 || f.type == 1 || f.type == 2 || f.type == 3) {
          var d = f.name + "=" + f.value, h = new a.VariableValue(
            d.split("=")[0],
            d.split("=")[1],
            1
          );
          f.type == 1 && (h.isAI = i || !1), a.editBody = h, a.editBody.tag = f.tag, a.Call.send(a.Eve.CREATE_METADATE_DATA, h, null), a.Call.send(a.Eve.ADD_DATABASE_DATA, [
            a.editBody,
            a.selectBody
          ], null), a.Call.send(a.Eve.SHIFT_REFRESH_LIBRARY_COORDINATES, [
            a.editBody,
          ...
          var d = f.name, h = new a.VariableValue(
            d.split("=")[0],
            void 0,
            f.type
          );
          ...
          v != null && v.sheets && (v.sheets = v.sheets.map((D) => ({
            ...D,
            data: new Map(Object.entries(JSON.parse(D.data)))
          }))), h.setSheetData(v), h.childCell = f.childCell, a.editBody = h, a.editBody.tag = f.tag, a.Call.send(a.Eve.ADD_DATABASE_DATA, [
            a.editBody,
            a.selectBody
          ], null), a.Call.send(a.Eve.SHIFT_REFRESH_LIBRARY_COORDINATES, [
            a.editBody,
        ...
        if (f.isFile == !0) {
          ...
          a.Call.send(a.Eve.CREATE_FILE_DATA, o, null), a.Call.send(a.Eve.ADD_DATABASE_DATA, [
            o,
            a.selectBody
          ], null), a.Call.send(a.Eve.SHIFT_REFRESH_LIBRARY_COORDINATES, [
            o,
            a.selectBody
          ], null), a.selectBody = o, a.selectBody.absoluteAddress = f.site, a.createLibraryBody(
            f.operationArray,
            !1,
            !1,
            o
    ...
    if (c.type == 5)
      a.editBody = new a.VariableValue(c.name, null, 5), a.editBody.tag = c.tag, a.editBody.isSystemShow = c.isSystemShow, a.Call.send(a.Eve.CREATE_OPERATION_DATA, a.editBody, null), a.Call.send(a.Eve.ADD_DATABASE_DATA, [
        a.editBody,
        a.selectBody
      ], null), a.Call.send(a.Eve.SHIFT_REFRESH_LIBRARY_COORDINATES, [
        a.editBody,
        a.selectBody
      ], null), a.editBody.absoluteAddress = c.site, a.targetStoragePool = a.editBody.childBodyArray;
    else if (c.type == 0 || c.type == 1 || c.type == 2 || c.type == 3) {
      var d = c.name + "=" + c.value, h = new a.VariableValue(
        d.split("=")[0],
        d.split("=")[1],
        1
      );
      c.type == 1 && (h.isAI = i || !1), a.editBody = h, a.editBody.tag = c.tag, a.Call.send(a.Eve.CREATE_METADATE_DATA, h, null), a.Call.send(a.Eve.ADD_DATABASE_DATA, [
        a.editBody,
        a.selectBody
      ], null), a.Call.send(a.Eve.SHIFT_REFRESH_LIBRARY_COORDINATES, [
        a.editBody,
      ...
      var d = c.name, h = new a.VariableValue(
        d.split("=")[0],
        void 0,
        c.type
      );
      const m = typeof c.sheetData == "string" ? JSON.parse(c.sheetData) : c.sheetData;
      m != null && m.sheets && (m.sheets = m.sheets.map((v) => ({
        ...v,
        data: new Map(Object.entries(JSON.parse(v.data)))
      }))), h.setSheetData(m), h.childCell = c.childCell, a.editBody = h, a.editBody.tag = c.tag, a.Call.send(a.Eve.ADD_DATABASE_DATA, [
        a.editBody,
        a.selectBody
      ], null), a.Call.send(a.Eve.SHIFT_REFRESH_LIBRARY_COORDINATES, [
        a.editBody,
...
n(a, "toRPN", function(t) {
  ...
  for (let f = 0; f < t.length; f++) {
    var h = t[f];
    if (a.isNumber(h) || d(h, f)) {
      let g = h, m = f + 1;
      for (; m < t.length && (a.isNumber(t[m]) || t[m] === "."); )
        g += t[m], m++;
      l(g), f = m - 1;
    } else if (u(h)) {
      for (var c = s[s.length - 1]; u(c) && (r[h] <= r[c] && h !== "^" || r[h] < r[c] && h === "^"); )
        o(), c = s[s.length - 1];
      s.push(h);
    } else if (h === "(")
      s.push(h);
  ...
  for (var i = 0; i < r.length; i++) {
    ...
    if (g.type == "OperationBody") {
      ...
      for (var u = 0; u < g.tree.length; u++) {
        ...
        v.id = m.id, o.tree.push(v);
      }
    } else if (g.type == "SymbolBody") {
      var s = 0, l = 0;
      g.view != null && (s = g.view.getX(), l = g.view.getY());
      var d = a.createSymbolData(
        g.type,
        g.operator,
        g.isFunctionId,
        g.isBindingOperation,
      ...
      g.isBindingFormula && (d.isFormula = !0, d.formulaName = g.formulaBody.name, d.formulaX = g.formulaBody.x, d.formulaY = g.formulaBody.y), d.id = g.id, t.push(d);
      for (var u = 0; u < g.tree.length; u++) {
        const y = g.tree[u];
        switch (y.type) {
          case "OperationBody":
          ...
          case "SymbolBody":
            ...
            c.id = y.id, d.tree.push(c), a.recursionSeekBody(
              c.tree,
              y.tree
            );
            break;
 ...
 * @returns {{}}
 */
n(a, "createVarData", function(t, r, i, s, l, o, u, d, h, c, f, g, m, v, D, y, p, T, C, V, x) {
  var b = {};
  return a.code, b.TID = t, b.name = r, b.value = i, b.type = s, b.macros = l, b.operator = o, b.enemy = u, b.tag = h, b.site = a.getAbsoluteAddress(d), b.statistics = c, b.upDateValue = f, b.demoteValue = g, b.funcType = m, b.isLogicalOpen = v, b.isDragging = D, b.currentStep = y, b.snNo = p, b.minValue = T, b.maxValue = C, b.step = V, b.logicalChildArray = [], x && x.length && x.forEach((F) => {
 ...
 * @returns {{}}
 */
n(a, "createBodyData", function(t, r, i, s, l, o, u, d) {
  var h = {};
  return h.tree = [], h.type = t, h.isFunction = r, h.isBoundOutput = i, h.x = s, h.y = l, h.isWeight = o, h.isAdvance = u, h.funcType = d, h;
}), /**
 * 创建符号体存储数据
 * @param type
 * @param operator
 ...
 * @returns {{}}
 */
n(a, "createSymbolData", function(t, r, i, s, l, o, u, d) {
  var h = {};
  return h.tree = [], h.type = t, h.operator = r, h.isFunctionId = i, h.isBoundOutput = s, h.x = l, h.y = o, h.isWeight = u, h.funcType = d, h;
}), /**
 * 创建标签存储数据
 * @param name
 * @param address
 ...
 * @returns {{}}
 */
n(a, "createOperationLayerData", function(t, r, i, s, l, o, u, d) {
  var h = {};
  return h.name = t, h.type = r, h.value = i, h.site = a.getAbsoluteAddress(s), h.tag = l, h.operationArray = [], r === 11 && u && (h.sheetData = u, h.childCell = d), h.isSystemShow = o, h;
}), /**
 * 创建看板存储数据
 * @param name
 * @param address
    ...
    if (y.type == "OperationBody" || y.type == "运算体类") {
      ...
      if (y.isFunction) {
        ...
        for (var d = 0; d < y.tree.length; d++) {
          const p = y.tree[d];
          if (p.type == 4) {
            var h = new a.VariableValue(
              p.name,
              null,
              p.type
            );
            h.TID = p.TID, h.TID == null && (h.TID = (/* @__PURE__ */ new Date()).getTime() + a.functionAddIndex, a.functionAddIndex++);
            var c = a.createFunctionBody(u, h);
            c.setMacros(a.amendMacros(p)), c.enemyFlag = p.enemy, c.funcType = p.funcType, c.funcType == null && (c.funcType = 0), c.statistics = p.statistics, c.upDateValue = p.upDateValue, c.demoteValue = p.demoteValue, a.symbolicLink(c, p.operator), a.Call.send(a.Eve.SHIFT_SHOW_VIEW, [
              c,
              p.operator,
              r
            ], null);
            ...
            h.TID = p.TID, h.TID == null && (h.TID = (/* @__PURE__ */ new Date()).getTime() + a.functionAddIndex, a.functionAddIndex++);
            var c = a.createFunctionBody(u, h);
            c.enemyFlag = p.enemy, c.funcType = p.funcType, c.funcType == null && (c.funcType = 0), c.statistics = p.statistics, c.upDateValue = p.upDateValue, c.demoteValue = p.demoteValue, c.isLogicalOpen = p.isLogicalOpen, c.isDragging = p.isDragging, c.snNo = p.snNo, c.logicalNumberList = p.logicalNumberList, c.currentStep = p.currentStep, c.snNo = p.snNo, c.minValue = p.minValue, c.maxValue = p.maxValue, c.step = p.step, c.logicalChildArray = [], p.logicalChildArray.forEach((V) => {
              var x = [];
              a.getLibraryBody(
                x,
                a.targetFolder.tree,
              ...
              var b = x[0], F = b.copy();
              F.enemyFlag = p.enemy, F.funcType = p.funcType, F.funcType == null && (F.funcType = 0), F.statistics = p.statistics, F.upDateValue = p.upDateValue, F.demoteValue = p.demoteValue, c.logicalChildArray.push(F);
            }), a.symbolicLink(c, p.operator), a.Call.send(a.Eve.SHIFT_SHOW_VIEW, [
              c,
              p.operator,
              r
            ], null);
            ...
            c.enemyFlag = p.enemy, c.funcType = p.funcType, c.funcType == null && (c.funcType = 0), c.statistics = p.statistics, c.upDateValue = p.upDateValue, c.demoteValue = p.demoteValue, a.symbolicLink(c, p.operator), a.Call.send(a.Eve.SHIFT_SHOW_VIEW, [
              c,
              p.operator,
              r
            ], null);
        ...
        for (var d = 0; d < y.tree.length; d++) {
          ...
          if (T.type == 4) {
            ...
            h.TID = T.TID, h.TID == null && (h.TID = (/* @__PURE__ */ new Date()).getTime() + a.functionAddIndex, a.functionAddIndex++);
            var c = a.createFunctionBody(u, h);
            c.setMacros(a.amendMacros(T)), c.enemyFlag = T.enemy, c.funcType = T.funcType, c.funcType == null && (c.funcType = 0), c.statistics = T.statistics, c.upDateValue = T.upDateValue, c.demoteValue = T.demoteValue, a.symbolicLink(c, T.operator), a.Call.send(a.Eve.SHIFT_SHOW_VIEW, [
              c,
              T.operator,
              r
            ], null);
            ...
            var g = f[0], c = a.createVariableBody(u, g);
            c.enemyFlag = T.enemy, c.funcType = T.funcType, c.funcType == null && (c.funcType = 0), c.statistics = T.statistics, c.upDateValue = T.upDateValue, c.demoteValue = T.demoteValue, a.symbolicLink(c, T.operator), a.Call.send(a.Eve.SHIFT_SHOW_VIEW, [
              c,
              T.operator,
              r
            ], null);
      ...
      if (y.isFormula) {
        var m = new a.FormulaData(
          y.formulaName,
          y.formulaX,
          y.formulaY
        );
        m.body = u, m.body.isBindingFormula = !0, u.formulaBody = m, a.Call.send(a.Eve.SHIFT_ADD_FORMULA, [
          m,
          u.view,
          r
        ], null);
      ...
      for (var d = 0; d < y.tree.length; d++) {
        ...
        if (T.type == "OperationBody" || T.type == "运算体类")
          if (T.isFunction) {
            ...
            for (var D = 0; D < T.tree.length; D++) {
              ...
              if (V.type == 4) {
                ...
                h.TID = V.TID, h.TID == null && (h.TID = (/* @__PURE__ */ new Date()).getTime() + a.functionAddIndex, a.functionAddIndex++);
                var c = a.createFunctionBody(
                  u,
                  h
                );
                c.macros = a.amendMacros(
                  V
                ), c.enemyFlag = V.enemy, c.funcType = V.funcType, c.funcType == null && (c.funcType = 0), c.statistics = V.statistics, c.upDateValue = V.upDateValue, c.demoteValue = V.demoteValue, a.symbolicLink(
                  c,
                  V.operator
                ), a.Call.send(a.Eve.SHIFT_SHOW_VIEW, [
                  c,
                  V.operator,
                  r
                ], null);
            ...
            a.Call.send(a.Eve.SHIFT_SHOW_VIEW_ON, [
              u,
              r
            ], null);
          } else {
            ...
            for (var D = 0; D < T.tree.length; D++) {
              ...
              if (x.type == 4) {
                ...
                h.TID = x.TID, h.TID == null && (h.TID = (/* @__PURE__ */ new Date()).getTime() + a.functionAddIndex, a.functionAddIndex++);
                var c = a.createFunctionBody(
                  u,
                  h
                );
                c.setMacros(
                  a.amendMacros(x)
                ), c.enemyFlag = x.enemy, c.funcType = x.funcType, c.funcType == null && (c.funcType = 0), c.statistics = x.statistics, c.upDateValue = x.upDateValue, c.demoteValue = x.demoteValue, a.symbolicLink(
                  c,
                  x.operator
                ), a.Call.send(a.Eve.SHIFT_SHOW_VIEW, [
                  c,
          ...
          u.isBindingOperation = a.getIsBoundOutput(
            T,
            i
          ), a.operationBindBody(u), u.view != null && (u.view.setX(
            a.coordinate(T, i)[0]
          ), u.view.setY(
            a.coordinate(T, i)[1]
          )), a.loopGenerateBody(u, T.tree, r), a.addBody(v, u, !1), a.Call.send(a.Eve.SHIFT_SHOW_VIEW_ON, [u, r], null);
        }
      }
      if (a.Call.send(a.Eve.SHIFT_SHOW_VIEW_ON, [v, r], null), y.isFormula) {
        ...
        m.body = v, m.body.isBindingFormula = !0, v.formulaBody = m, a.Call.send(a.Eve.SHIFT_ADD_FORMULA, [
          m,
          v.view,
          r
        ], null);
...
n(a, "createOperationBody", function(t, r, i, s, l, o) {
  ...
  return a.Call.send(
    ...
    [t, r, i, u],
    (function(h) {
      d = h, s && d && d.openWeight(), l && d && d.openAdvance();
    }).bind(this)
  ), u;
}), /**
 * 生成书签
...
n(a, "createSymbolBody", function(t, r, i, s, l, o) {
  ...
  return u.isWeight = l, u.isFunctionId = s, u.funcType = o, (u.funcType == null || u.funcType == null) && (u.funcType = 0), u.operator = i, u.isFunctionId == null && (u.isFunctionId = 1), t != null && u.addBody(t), r != null && u.addBody(r), a.targetStoragePool.push(u), a.Call.send(a.Eve.SHIFT_ADD_SYMBOLBODY, [
    t,
    r,
    i,
    s,
  ...
  for (var s = 0; s < r.length; s++) {
    ...
    switch (g.type) {
        ...
        if (g.isFunction) {
          ...
          for (var o = 0; o < g.tree.length; o++) {
            ...
            if (m.type == 4) {
              ...
              u.TID = m.TID, u.TID == null && (u.TID = (/* @__PURE__ */ new Date()).getTime() + a.functionAddIndex, a.functionAddIndex++);
              var d = a.createFunctionBody(
                l,
                u
              );
              d.macros = a.amendMacros(m), d.enemyFlag = m.enemy, d.funcType = m.funcType, d.funcType == null && (d.funcType = 0), d.statistics = m.statistics, d.upDateValue = m.upDateValue, d.demoteValue = m.demoteValue, a.symbolicLink(d, m.operator), a.clickBody = d, a.Call.send(a.Eve.SHIFT_SHOW_VIEW, [
                d,
                m.operator,
                i
              ], null);
              ...
              var c = h[0], d = a.createVariableBody(
                l,
                c
              );
              d.enemyFlag = m.enemy, d.funcType = m.funcType, d.funcType == null && (d.funcType = 0), d.statistics = m.statistics, d.upDateValue = m.upDateValue, d.demoteValue = m.demoteValue, a.symbolicLink(d, m.operator), a.Call.send(a.Eve.SHIFT_SHOW_VIEW, [
                d,
                m.operator,
                i
              ], null);
          ...
          for (var o = 0; o < g.tree.length; o++) {
            ...
            if (D.type == 4) {
              ...
              d.setMacros(a.amendMacros(D)), d.enemyFlag = D.enemy, d.funcType = D.funcType, d.funcType == null && (d.funcType = 0), d.statistics = D.statistics, d.upDateValue = D.upDateValue, d.demoteValue = D.demoteValue, a.symbolicLink(d, D.operator), a.Call.send(a.Eve.SHIFT_SHOW_VIEW, [
                d,
                D.operator,
                i
              ], null);
              ...
              d.enemyFlag = D.enemy, d.funcType = D.funcType, d.funcType == null && (d.funcType = 0), d.statistics = D.statistics, d.upDateValue = D.upDateValue, d.demoteValue = D.demoteValue, a.symbolicLink(d, D.operator), a.Call.send(a.Eve.SHIFT_SHOW_VIEW, [
                d,
                D.operator,
                i
              ], null);
      ...
      case "SymbolBody":
        ...
        f.isBindingOperation = a.getIsBoundOutput(r[s]), a.operationBindBody(f), f.view != null && (f.view.setX(a.coordinate(r[s])[0]), f.view.setY(a.coordinate(r[s])[1])), a.loopGenerateBody(f, g.tree, i), a.addBody(t, f, !1), a.Call.send(a.Eve.SHIFT_SHOW_VIEW_ON, [f, i], null);
        break;
    }
  }
...
}), a), globalThis_ = /* @__PURE__ */ function() {
...
const L = class L {
  ...
  getPlayerInstance() {
    ...
    console.log(i), r.parameterInfoArray = t.parameterInfoArray;
    let l = r.parameterInfoArray[1 - 1];
    return gameManualOverrideParameter(r, l), r;
  }
  /**
   * 根据敌人ID获取敌人实例
  ...
  getEnemyInstance(t) {
    ...
    i.name = r.name, i.getBillboard(), i.parameterInfoArray = r.parameterInfoArray;
    let l = i.parameterInfoArray[1 - 1];
    return gameManualOverrideParameter(i, l), i;
  }
  /**
   * 根据角色名称获取实例
   ...
   */
  getInstanceByName(t) {
    let r = this._fxData.find((u) => u.name === t);
    if (!r)
      return console.warn(`未找到名称为 "${t}" 的角色配置`), null;
    let i = new Player();
    i.name = r.name, console.log(`创建角色实例: ${i.name}`);
    let s = i.getBillboard();
    console.log(s), i.parameterInfoArray = r.parameterInfoArray;
    let o = i.parameterInfoArray[1 - 1];
    return gameManualOverrideParameter(i, o), i;
  }
  /**
   * 改变玩家等级和职业
   ...
   */
  changePlayerLevelAndOccu(t, r, i) {
    let l = t.parameterInfoArray.find(
      (o) => o.parameterInfoname == t.name
    );
    l && l.parameterInfoArray.forEach((o) => {
      o.parameter.forEach((u) => {
        u.path === "等级" ? u.value = r : u.path === "职业" && (u.value = i);
      });
    }), gameManualOverrideParameter(t, l);
  }
  /**
   * 加载配置数据
  ...
  loadConfig(t) {
    ...
    l.addEventListener(EventManager.SHIFT_ADD_BOARD, (d) => {
      let h = new BillboardLayer(d.name);
      h.monitored = d.monitored;
      let c = h;
      for (var f = 0; f < d.operationArray.length; f++) {
        var g = [];
        fx.getLibraryBody(
          g,
          fx.targetFolder.tree,
          d.operationArray[f].site
        ), fx.clickBody = g[0], c.pushOperationLayer(), fx.clickBody = null;
      }
      for (var f = 0; f < d.metadataArray.length; f++) {
        var g = [];
        fx.getLibraryBody(
          g,
          fx.targetFolder.tree,
          d.metadataArray[f].site
        ), fx.clickBody = g[0];
        let D = d.metadataArray[f];
        c.pushMetadata(
          D.componentType,
          D.componentMinValue,
          D.componentMaxValue,
    ...
    }), l.addEventListener(EventManager.SHIFT_ADD_CHARTS, (d) => {
      var h = new ChartsLayer(d.name);
      let c = h;
      for (var f = 0; f < d.operationlayer.length; f++) {
        var g = [];
        fx.getLibraryBody(
          g,
          fx.targetFolder.tree,
      ...
      var g = [];
      c.minValue = d.minValue, c.intervalValue = d.intervalValue, c.maxValue = d.maxValue, d.metadataArray || (d.metadataArray = []), d.metadata && (d.metadataArray = [
        {
          site: d.metadata,
      ...
      for (var f = 0; f < d.metadataArray.length; f++) {
        var g = [], m = d.metadataArray[f];
        fx.getLibraryBody(g, fx.targetFolder.tree, m.site);
        var v = g[0].copy();
        v.intervalValue = m.intervalValue || 1, v.minValue = m.minValue || 1, c.metadataArray.push(v), c.metadata = v;
      }
    ...
    console.log("-------------------"), u.forEach((d) => {
      let h = d.getFormula("攻击"), c = d.getFormula("生命"), f = d.getFormula("防御");
      console.log("name", d.name), console.log("attack", h), console.log("hp", c), console.log("defense", f);
    }), this.playerList = u;
  }
  /**
   * 根据职业和等级获取数据
  ...
  getInstanceDataByNameAndOccuAndLevel(t, r, i) {
    let s = this.playerList.find((d) => d.name === t);
    if (!s)
      throw new Error(`未找到名称为 "${t}" 的玩家`);
    this.changePlayerLevelAndOccu(s, i, r);
  ...
  getSheetDataByPath(t) {
    ...
    for (let o = 0; o < r.length; o++) {
      let u;
      if (i.isFolder) {
        if (u = i.tree.find((d) => d.name == r[o]), !u)
...
n(L, "_instance");
let FxUtil = L;
function gameManualOverrideParameter(e, t) {
  const r = e.getBillboard();
  t.parameterInfoArray.forEach((i, s) => {
    i && r.forEach((l, o) => {
      i.name === l.name && i.parameter.forEach((u, d) => {
        const h = u.path;
        l.metadataArray.forEach((c, f) => {
          const g = [];
          if (fx.getStepData(c.body.source, g), g.toString() === h) {
            const v = c.body.getValue(), D = Number(u.value);
            v !== D && c.body.setGlobalValue(D);
          }
        });
      });
    });
...
🏆 战斗场景: ${i.name}`), console.log(`主角等级: ${i.heroLevel} | 敌人等级: ${i.enemyLevel}`);
    const s = new BattleLogger(), l = e.getInstanceDataByNameAndOccuAndLevel("主角1", 1, i.heroLevel), o = new BattleEntity(
      ...
      i.heroLevel,
      1
    ), u = e.getInstanceDataByNameAndOccuAndLevel("怪物1", 2, i.enemyLevel), d = new BattleEntity(
      "巨龙",
      u.hp,
      u.attack,
      u.defense,
      i.enemyLevel,
      1
    ), c = new BattleSimulator(o, d, s).startBattle();
...
async function generatePVEData(e, t = 50) {
  ...
  for (let l = 1; l <= t; l++) {
    ...
    try {
      const o = new BattleLogger(), u = i.getInstanceDataByNameAndOccuAndLevel("主角1", 1, l), d = new BattleEntity(
        "勇者",
        u.hp,
        u.attack,
        u.defense,
        l,
        1
      ), h = i.getInstanceDataByNameAndOccuAndLevel("怪物1", 1, l), c = new BattleEntity(
        "巨龙",
        h.hp,
        h.attack,
        h.defense,
      ...
      console.log("进行战斗", l), console.log("hero", d), console.log("enemy", c);
      const g = new BattleSimulator(d, c, o).startBattle();
      let m = 0, v = 0;
      if (g.battleData && g.battleData.length > 0)
        for (const p of g.battleData)
          p.heroDamageDealt !== void 0 && (m += p.heroDamageDealt, v++);
      const D = v > 0 ? m / v : 0, y = {
        level: l,
        hp: d.currentHp,
        // 主角剩余的血量
